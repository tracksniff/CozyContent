...
import { User, Search, Shield, ShieldAlert, Plus, Mail } from 'lucide-react';
      ...
      <main className="flex-grow ml-20 lg:ml-64 p-8 lg:p-12 transition-all duration-500">
        <div className="max-w-6xl mx-auto">
          <header className="mb-12 flex justify-between items-center">
            <div>
              <h1 className="text-4xl font-black font-headline text-on-surface tracking-tight mb-2">User Management</h1>
              <p className="text-on-surface-variant font-medium">Manage all users registered on the platform.</p>
            </div>
