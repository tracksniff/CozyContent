    ...
    <div style={{ maxWidth: '820px', margin: '0 auto', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <div style={{
        ...
        <div style={{ padding: '40px 48px 48px' }}>
          <a
            href={`${import.meta.env.VITE_API_URL}/api/google/login/?next=${encodeURIComponent(window.location.href)}`}
            style={{
              display: 'flex',
              alignItems: 'center',
          ...
          <div style={{ position: 'relative', marginBottom: '32px', textAlign: 'center' }}>
            <div style={{ position: 'absolute', top: '50%', left: 0, right: 0, height: '1px', background: 'var(--color-outline-variant)', zIndex: 0 }}></div>
            <span style={{ position: 'relative', zIndex: 1, background: 'var(--color-surface)', padding: '0 16px', fontSize: '10px', fontWeight: 800, color: 'var(--color-on-surface-variant)', textTransform: 'uppercase', letterSpacing: '0.14em' }}>Or enter manually</span>
          </div>
