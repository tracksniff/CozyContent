...
const industryDemos = {
  ...
  Electrical: [
    ...
    { name: "Bright Current Ltd", url: "https://bright-current-ltd.vercel.app/", image: e2 },
    { name: "Zap Electrical Services", url: "https://zap-electrical-services.vercel.app/", image: e3 },
  ],
  Roofing: [
    { name: "SkyGuard Roofing", url: "https://skyguard-roofing.vercel.app/", image: ro1 },
    { name: "Peak Performance Roofs", url: "https://peak-performance-roofs.vercel.app/", image: ro2 },
    { name: "Durable Slate Co", url: "https://durable-slate-co.vercel.app/", image: ro3 },
  ],
  Locksmith: [
    { name: "SureLock Security", url: "https://surelock-security.vercel.app/", image: l1 },
    { name: "QuickKey Responders", url: "https://quickkey-responders.vercel.app/", image: l2 },
    { name: "Fortress Lock & Key", url: "https://fortress-lock-and-key.vercel.app/", image: l3 },
  ],
  Cleaning: [
    { name: "Sparkle & Shine Co", url: "https://sparkle-and-shine-co.vercel.app/", image: c1 },
    { name: "Pristine Office Care", url: "https://pristine-office-care.vercel.app/", image: c2 },
    { name: "EcoGreen Cleaners", url: "https://ecogreen-cleaners.vercel.app/", image: c3 },
  ],
  Removals: [
    { name: "SwiftMove Logistics", url: "https://swiftmove-logistics-red.vercel.app/", image: r1 },
    { name: "Careful Carry Removals", url: "https://careful-carry-removals.vercel.app/", image: r2 },
    { name: "City to City Transit", url: "https://cit-to-city-transit.vercel.app/", image: r3 },
  ],
};
